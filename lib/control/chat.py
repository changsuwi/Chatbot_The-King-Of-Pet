# -*- coding: utf-8 -*-
"""
Created on Wed May 03 16:02:42 2017

@author: vic
"""
from ..json_fb import json_message, json_chat_quickreply
...
def chat(sender_id, message_text):
    ...
    elif((u"抓" in message_text and u"貓" in message_text and (u"家具" in message_text or u"傢俱" in message_text or u"傢具"in message_text or u'沙發'in message_text))):  # 亂抓傢具
    ...
    # http://petbird.tw/article13607.html
        ...
        json_message(
            sender_id, "當貓咪在你面前躺下翻肚子且四腳朝天的時候，就表示牠是很喜歡你的，而且很滿足主人的在身旁的陪伴與互動，這時候只要輕輕摸牠的頭就好，摸肚子可能會受貓爪攻擊或被貓咬。")
