        ...
        for entry in data["entry"]:
            for messaging_event in entry["messaging"]:
                ...
                if messaging_event.get("message"):  # someone sent us a message
                    ...
                    elif((u"訓練" or u"教") and u"貓" in message_text):
                        if((u"半夜" or u"晚上") and( u"吵" or u"叫")in message_text):#半夜亂叫
                            json_message(sender_id,"糾正深夜擾人的貓咪方法\n1、白天增新鮮感\n很怕貓咪到了半夜就會開始擾人，所以在白天的時候就要增加牠的活動量，可以和牠玩遊戲，可以在窗邊擺貓跳台讓牠觀看風景，玩具要隔幾天就做更換，保持新鮮感才不會無聊。\n2、不要早上餵貓\n不要在早上餵貓咪吃東西，否則當吃飯的時間一到，牠一大早的就會喵喵叫得叫你起床，可以一天內分多次餵少量食物，白天沒人在家時就可以考慮使用自動計時餵食器。\n3、發出聲響嚇牠\n可以在貓咪晚上要開始玩耍的時候，發出聲響嚇牠一跳，當這樣的次數多了，就可以矯正牠的行為，但是千萬不能讓貓咪發現聲響是你製造出來的，否則這樣就沒有什麼效果了。\n4、忽視夜間行為\n主人必須做到完全忽視貓咪的夜間行為，吵著要你起床時也要堅持住不去理牠，要徹底地不去理會牠，如果吵到一半就理牠，會讓牠覺得只要堅持住就一定能達到目的。")
                        elif(u"抓" and (u"家具" or u"傢俱" or u"傢具") in message_text):#亂抓傢具
